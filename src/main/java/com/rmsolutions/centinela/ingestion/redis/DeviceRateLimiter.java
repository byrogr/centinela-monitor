 ...
 *
 * <p>FAIL-SAFE, Y AQUI SE ABRE: si Redis no responde, se DEJA PASAR el evento.
 *
 * <p>Parece contradictorio con "ante la duda, escalar", pero es justo lo mismo: el
 ...
 *
 * <p>(La autenticacion, en cambio, falla CERRADA: ver DeviceRegistryService.)
 *
 * @author Roger Rojas
 * @since 2026-09-18
 */
