...
import com.rmsolutions.centinela.persistence.repository.AlertRuleRepository;
import com.rmsolutions.centinela.persistence.repository.CaregiverLinkRepository;
import com.rmsolutions.centinela.persistence.repository.DeviceRepository;
import com.rmsolutions.centinela.persistence.repository.EventRepository;
import com.rmsolutions.centinela.persistence.repository.PatientRepository;
import com.rmsolutions.centinela.persistence.repository.SilenceIncidentRepository;
...
class PersistenciaJpaTest {
    ...
    void laCadenaDeEscaladoLlegaOrdenada() {
        assertThat(links.findByIdPatientIdOrderByEscalationOrderAsc(paciente.getId()))
                .extracting(l -> l.getEscalationOrder())
                .containsExactly(1, 2);
    }
    ...
    void cadaSeveridadTieneSuReglaDeAlerta() {
        ...
        assertThat(rules.findByPatientIdAndSeverityAndEnabledTrue(paciente.getId(), Severity.CRITICAL))
                .isPresent()
                .get()
                .extracting(r -> r.getEscalateAfterSeconds())
                .isEqualTo(60);
    }
